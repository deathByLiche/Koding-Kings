...
namespace TriviaMaze
{
    class MazeFactory
    {
        ...
        private void setupDoors(Room[][] mazeRooms, int row, int col, Room r)
        {
            ...
            //E Door
            this.makeDoor(doors, DOORHEIGHT, DOORWIDTH, ((col + 1) * ROOMWIDTH + (col + 1) * DOORWIDTH), (row * (DOORHEIGHT + 10)) + 10, 1);
            ...
            if (col != 0)
                ...
                this.makeDoor(doors, DOORHEIGHT, DOORWIDTH, (col * ROOMWIDTH + col * DOORWIDTH), (row * (DOORHEIGHT + 10)) + 10, 3);
